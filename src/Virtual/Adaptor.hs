...
-- total -> o contexto total original
-- a -> tupla (valor, resto)

data Adaptor a total = Adaptor {dec :: total ->  a, cmp :: a ->  total}
...
ad_quad1 :: 
    Adaptor (a1, ((a2, a3), a4)) (((a1, a2), a3), a4)
ad_quad1 = Adaptor {
...
ad_quad2 :: 
    Adaptor (a2, (a1, (a3, a4))) (((a1, a2), a3), a4)
ad_quad2 = Adaptor {
...
ad_quad3 :: 
    Adaptor (a3, ((a1, a2), a4)) (((a1, a2), a3), a4)
ad_quad3 = Adaptor {
...
ad_quad4 ::
    Adaptor (a4, ((a1, a2), a3)) (((a1, a2), a3), a4)
ad_quad4 = Adaptor {
...
ad_quad13 :: 
    Adaptor ((a1, a3), (a2, a4)) (((a1, a2), a3), a4)
ad_quad13 = Adaptor {
...
ad_quad23 :: 
    Adaptor ((a2, a3), (a1, a4)) (((a1, a2), a3), a4)
ad_quad23 = Adaptor {
...
ad_quad34 :: 
    Adaptor ((a3, a4), (a1, a2)) (((a1,a2),a3),a4)
ad_quad34 = Adaptor {
...
ad_quad124 :: 
    Adaptor (((a1, a2), a4), a3) (((a1, a2), a3), a4)
ad_quad124 = Adaptor {
...
ad_quad134 :: 
    Adaptor (((a1, a3), a4), a2) (((a1, a2), a3), a4)
ad_quad134 = Adaptor {
...
ad_quad234 :: 
    Adaptor (((a2, a3), a4), a1) (((a1, a2), a3), a4)
ad_quad234 = Adaptor {
